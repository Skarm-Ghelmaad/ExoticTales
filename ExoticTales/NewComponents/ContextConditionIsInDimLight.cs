...
namespace ExoticTales.NewComponents
{
    class ContextConditionIsInDimLight : ContextCondition
    {
        ...
        bool exactingCheck = false;          /* This setting is to allow a nuanced evaluation of dim light, which is exactly a mirror to the ContextConditionIsInBrightLight.
                                            */

        bool weatherCheck = false;          /* This setting is to allow a nuanced evaluation of dim light, which is exactly a mirror to the ContextConditionIsInBrightLight.
                                             */

        bool checkCaster = false;           // Check if caster is in dim light. Only to consider if you have included enhancing buffs or facts.
        bool checkTarget = false;           // Check if target is in dim light. Only to consider if you have included enhancing buffs or facts.
        bool triggeringBuffs = false;        // Set as "true" if you want to add a list of buffs that, if applied to the caster or the target, will override the current environmental light and cause the dim light.
        bool triggeringFacts = false;        // Set as "true" if you want to add a list of facts that, if applied to the caster or the target, will override the current environmental light and cause the dim light.
        bool suppressingBuffs = false;        // Set as "true" if you want to add a list of buffs that, if applied to the caster or the target, will override the current environmental light and negating the dim light.
        bool suppressingFacts = false;        // Set as "true" if you want to add a list of facts that, if applied to the caster or the target, will override the current environmental light and negating the dim light.
