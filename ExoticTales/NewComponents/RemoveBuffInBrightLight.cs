...
namespace ExoticTales.NewComponents
{
    ...
    public class RemoveBuffInBrightLight : UnitFactComponentDelegate, IWeatherChangeHandler, IGlobalSubscriber, ISubscriber, IAreaLoadingStagesHandler, IUnitBuffHandler, IUnitGainFactHandler, IUnitLostFactHandler
    {
